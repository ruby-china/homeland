...
class HTMLwithSyntaxHighlight < Redcarpet::Render::HTML
  def block_code(code, language)
    allow_languages = %w(cucumber Gherkin gherkin abap ada ada95ada2005 ahk antlr-as antlr-actionscript antlr-cpp antlr-csharp antlr-c# 
    ...
    language = 'text' if not allow_languages.include?(language)
