...
ActiveRecord::Schema.define(version: 20_160_518_083_347) do
  ...
  create_table 'devices', force: :cascade do |t|
    ...
    t.index %w(user_id platform), name: 'index_devices_on_user_id_and_platform', using: :btree
  ...
  create_table 'new_notifications', force: :cascade do |t|
    ...
    t.datetime 'created_at',         null: false
    t.datetime 'updated_at',         null: false
    t.index %w(user_id notify_type), name: 'index_new_notifications_on_user_id_and_notify_type', using: :btree
  ...
  create_table 'oauth_applications', force: :cascade do |t|
    ...
    t.integer  'owner_id'
    t.string   'owner_type'
    t.index %w(owner_id owner_type), name: 'index_oauth_applications_on_owner_id_and_owner_type', using: :btree
  ...
  create_table 'page_versions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(page_id version), name: 'index_page_versions_on_page_id_and_version', using: :btree
