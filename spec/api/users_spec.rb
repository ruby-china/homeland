...
describe "API V3", "users", type: :request do
  describe "GET /api/v3/users.json" do
    ...
    it "should work" do
      ...
      expect(json["users"][0]).to include("id", "name", "login", "avatar_url")
    end
  ...
  describe "GET /api/v3/users/:login.json" do
    it "should get user details with list of topics" do
      ...
      expect(json["meta"]).to include("blocked", "followed")
    end
  ...
  describe "GET /api/v3/users/:login/followers.json" do
    ...
    it "should work" do
      ...
      expect(json["followers"][0]).to include("id", "name", "login", "avatar_url")
  ...
  describe "GET /api/v3/users/:login/blocked.json" do
    ...
    it "should work" do
      ...
      expect(json["blocked"][0]).to include("id", "name", "login", "avatar_url")
  ...
  describe "GET /api/v3/users/:login/following.json" do
    ...
    it "should work" do
      ...
      expect(json["following"][0]).to include("id", "name", "login", "avatar_url")
